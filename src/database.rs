...
use crate::types::*;
pub const NULLARY: [Signature; 306] = [
    ...
    Nullary("allcameras", Array, "Returns information about all cameras (camera type objects, and the currently active camera)"),
    ...
    Nullary("allextensions", Array, "Returns information about all loaded Extensions"),
    ...
    Nullary("focuson", Object, "Returns the person in camera focus."),
    ...
    Nullary("getmissionlayers", Array, "Returns a list of all layers created in editor."),
    Nullary("getmissionoptions", HashMap, "Returns the various mission options"),
    ...
    Nullary("getserverinfo", HashMap, "Returns information about the servers configuration and state."),
    ...
    Nullary("isusingaisteeringcomponent", Boolean, "Returns whether the AI steering component setting is enabled globally"),
    ...
    Nullary("playertargetlock", Array, "Returns the players current locking/locked target"),
    Nullary("privateall", Nothing, "Disables implicit access to local variables from parent scopes. To access variables from parent scopes after using 'privateAll', use the 'import' command."),
    ...
    Nullary("remoteexecutedjipid", String, "Returns persistent JIP ID of the remotely executed command. Return \"\" if JIP ID can't be determined"),
    Nullary("remoteexecutedowner", Number, "Returns ID of the original owner of the remotely executed command. Return 0 if owner can't be determined"),
    ...
    Nullary("save3denpreferences", Boolean, "Saves 3DEN attributes into save file."),
...
(Obsolete)."),
    ...
    Nullary("uitime", Number, "Returns the UI time that elapsed since the mission started (in seconds)."),
...
pub const UNARY: [Signature; 1508] = [
    ...
    Unary("addcuratorselected", Array, Nothing, "Add new items to curator selected items"),
    ...
    Unary("angularvelocity", Object, Array, "Returns the angular velocity of the vehicle as an array with format [x, y, z]."),
    Unary("angularvelocitymodelspace", Object, Array, "Returns the angular velocity of the vehicle in model space as an array with format [x, y, z]."),
    ...
    Unary("assigneditems", Array, Array, "Get array with some or all assigned items."),
    Unary("assigneditems", Object, Array, "Get array with some or all assigned items."),
    ...
    Unary("backpacks", Object, Array, "Returns backpacks unit has in inventory"),
    ...
    Unary("boundingboxreal", Array, Array, "Returns a bounding box of given object's LOD in model coordinates space. The result is in format [[minX, minZ, minY], [maxX, maxZ, maxY]]."),
...
Note: the stop command is never finished; the unit will never be ready."),
    ...
    Unary("compilefinal", Code, Code, "Compile expression. Expression cannot be overridden."),
    Unary("compilefinal", HashMap, HashMap, "Creates a read-only copy of the provided HashMap."),
    ...
    Unary("createhashmapobject", Array, HashMap, "Creates a new HashMap from given [key,value] array and calls constructor."),
    ...
    Unary("createsoundsourcelocal", Array, Object, "Creates a sound source of the given type (type is the name of the subclass of CfgVehicles). If the markers array contains several marker names, the position of a random one is used. Otherwise, the given position is used. The sound source is placed inside a circle with this position as its center and placement as its radius."),
    ...
    Unary("createvehiclelocal", Array, Object, "Creates a vehicle of the given type (type is the name of the subclass in CfgVehicles). If the markers array contains several marker names, the position of a random one is used. Otherwise, the given position is used. The vehicle is placed inside a circle with this position as center and placement as its radius. Special properties can be: \"NONE\", \"FLY\" and \"FORM\". Vehicle is not transferred through network in MP games."),
    ...
    Unary("ctrlmapdir", Control, Number, "Returns the current orientation of the map control."),
    ...
    Unary("ctrlmodelvectorside", Control, Array, "Returns model side vector in given control."),
    ...
    Unary("curatorselectionpreset", Number, Array, "Retrieve the items in the given selection preset"),
    ...
    Unary("cutobj", Array, Nothing, "Object background - the argument uses format [\"name\",\"type\",speed, showInMap, drawOverHUD] or [\"name\",\"type\"]. If speed is not given, it's assumed to be one.
The object can be defined in the description.ext file."),
    Unary("cutrsc", Array, Nothing, "Resource background - the argument uses format [\"name\",\"type\",speed, showInMap, drawOverHUD] or [\"name\",\"type\"]. If speed is not given, it's assumed to be one.
The resource can be defined in the description.ext file."),
    Unary("cuttext", Array, Nothing, "Text background - the argument uses format [\"text\",\"type\",speed, showInMap, isStructuredText, drawOverHUD] or [\"text\",\"type\"]. If speed is not given, it's assumed to be one. Type may be one of: \"PLAIN\", \"PLAIN DOWN\", \"BLACK\", \"BLACK FADED\", \"BLACK OUT\", \"BLACK IN\", \"WHITE OUT\" or \"WHITE IN\"."),
    ...
    Unary("deletevehicle", Array, Nothing, "Deletes any unit or vehicle. Only vehicles inserted in the editor or created during a mission can be deleted. The player unit cannot be deleted."),
    ...
    Unary("diag_remainscollector", Number, Array, "Returns information about current state of remains collector according to given option"),
    ...
    Unary("diag_testscriptsimplevm", Code, String, "Tests if provided code can be translated to and use Simple VM execution."),
    ...
    Unary("difficultyoption", Array, Array, "Returns array with all difficulty options and their values"),
...
Note: the stop command is never finished; the unit will never be ready."),
    ...
    Unary("execfsm", Array, Number, "Executes given FSM script"),
...
When used on anything else, objNull is returned."),
    ...
    Unary("forcehitpointsdamagesync", Object, Boolean, "Forced hitpoints damage on given entity"),
    ...
    Unary("fromjson", String, Anything, "Converts given json in string to script value."),
    ...
    Unary("get3dengrid", String, Number, "Gets grid size of given grid type."),
    Unary("get3denlayer", Array, Number, "Returns Entity ID of the layer this entity is on."),
    Unary("get3denlayer", Group, Number, "Returns Entity ID of the layer this entity is on."),
    Unary("get3denlayer", Number, Number, "Returns Entity ID of the layer this entity is on."),
    Unary("get3denlayer", Object, Number, "Returns Entity ID of the layer this entity is on."),
    Unary("get3denlayer", String, Number, "Returns Entity ID of the layer this entity is on."),
    Unary("get3denlayerentities", Number, Array, "Returns list of all items from inside of given layer."),
    Unary("get3denparent", Array, Anything, "Returns Entity's parent'"),
    Unary("get3denparent", Group, Anything, "Returns Entity's parent'"),
    Unary("get3denparent", Number, Anything, "Returns Entity's parent'"),
    Unary("get3denparent", Object, Anything, "Returns Entity's parent'"),
    Unary("get3denparent", String, Anything, "Returns Entity's parent'"),
    ...
    Unary("getallunittraits", String, Array, "Returns all units traits currently present on that unit"),
    ...
    Unary("getbonenames", Object, Array, "Gets the array of bone names for the specified object, in format [boneName1, parentName1, boneName2, parentName2,...]"),
    ...
    Unary("getcorpseweaponholders", Object, Array, "Returns primary and secondary weapon holders for a corpse."),
    ...
    Unary("getentityinfo", Object, Array, "Returns various information about given vehicle"),
    ...
    Unary("getfuelconsumptioncoef", Object, Number, "Returns the fuel consumption coefficient of the vehicle"),
    ...
    Unary("getleaning", Object, Number, "Returns unit leaning factor from -1 to 1"),
    ...
    Unary("getmodelinfo", Object, Array, "Returns object's model info in format [modelName, modelPath, hasSkeleton, placingPoint, mass]. Model path is suitable for use with <f>createSimpleObject</f> command."),
    ...
    Unary("getphysicscollisionflag", Object, Array, "Returns the currently set physics collision flags"),
    Unary("getpilotcameradirection", Object, Array, "Returns pilot camera direction (model space)"),
    Unary("getpilotcameraopticsmode", Object, Number, "Return the optics mode index"),
    ...
    Unary("getrespawnvehicleinfo", Object, Array, "Returns respawn params for the given vehicle"),
    ...
    Unary("getshotinfo", Object, Array, "Returns various information about given shot"),
    ...
    Unary("getunitmovesinfo", Object, Array, "Returns an array of unit moves information"),
    Unary("getunitstate", Object, String, "Returns current state of the given AI unit"),
    ...
    Unary("getwaterfillpercentage", Object, Number, "Gets the current water fill percentage"),
    Unary("getwaterleakiness", Object, Number, "Gets the current water leakiness"),
    ...
    Unary("hascustomface", Object, Boolean, "Returns whether or not the user has a custom face in their profile"),
    ...
    Unary("hashvalue", HashMap, String, "Returns the hash of a value."),
    ...
    Unary("ignore3denhistory", Code, Nothing, "Ignores all history steps created by executing given code."),
    Unary("image", String, String, "Creates a structured text containing the given image."),
    Unary("import", Array, Nothing, "Can be used to selectively import local variables from parent scopes after using 'privateAll'. The imported variables will be private to the current scope."),
    Unary("import", String, Nothing, "Can be used to selectively import local variables from parent scopes after using 'privateAll'. The imported variables will be private to the current scope."),
    ...
    Unary("isaisteeringcomponentenabled", Object, Boolean, "Returns whether the AI steering component is enabled"),
    ...
    Unary("isfinal", Anything, Boolean, "Checks whether or not the passed variable is read-only."),
...
Note: a==TaskNull does not work, because taskNull is not equal to anything, even to itself."),
    ...
    Unary("isremotecontrolling", Object, Boolean, "Returns true if the given player is controlling a unit"),
    ...
    Unary("isswitchingweapon", Object, String, "Returns true if unit is currently switching weapon"),
    Unary("istext", Config, Boolean, "Check if config entry represents text."),
    Unary("isthrowable", String, Boolean, "Checks if the given magazine is throwable."),
    ...
    Unary("landat", Object, Array, "Returns array with [mode, result, position, waitTime] for the given aircraft."),
    ...
    Unary("load3denscenario", String, Boolean, "Loads either new mission in world, or given scenario inside 3DEN"),
    ...
    Unary("loadcuratorselectionpreset", Number, Nothing, "Load the given saved selection preset as the current selection"),
...
Note: this function is identical to <f>getMarkerColor</f>."),
    ...
    Unary("markerdrawpriority", String, Number, "Returns current marker draw priority"),
...
Note: this function is identical to <f>getMarkerType</f>."),
    ...
    Unary("missilestate", Object, Array, "Returns current engine,target lock and flight profile states of given guided missile"),
    ...
    Unary("name", Namespace, String, "Returns the name of the given namespace"),
...
<t>Number</t>, <t>Boolean</t>, <t>Object</t> and <t>Group</t>."),
    ...
    Unary("remotecontrolled", Object, Object, "Returns the player controling the given unit or the unit controlled by the given player."),
    ...
    Unary("removeallassigneditems", Array, Nothing, "Removes some or all of the linked items from gear."),
    Unary("removeallassigneditems", Object, Nothing, "Removes some or all of the linked items from gear."),
    ...
    Unary("removeallmagazines", Object, Nothing, "Removes all magazines from the given entity"),
    ...
    Unary("ropecreate", Array, Object, "Creates instance of a rope object attached to a vehicle"),
    ...
    Unary("screentoworlddirection", Array, Array, "Returns the direction towards the point corresponding to the given point on screen (in UI coordinates)."),
...
This command needs to be executed from UI handler to succeed and mirrors serverCommand behavior. See also <f>serverCommand</f>"),
    Unary("set3denattachedcursorentity", HashMap, Nothing, "Start a unit creation operation and attach to mouse cursor."),
    ...
    Unary("setcompassdeclination", Number, Nothing, "Set the declination angle of the compass (in radians), which is the difference between Magnetic North and True North."),
    Unary("setcompassoscillation", Array, Nothing, "Set Compass Oscillation."),
    Unary("setcuratorselected", Array, Nothing, "Set the curator selected items"),
    ...
    Unary("setmissionoptions", HashMap, Nothing, "Sets various mission options."),
    ...
    Unary("setsimulweatherlayers", Number, Nothing, "Sets simul weather layers. 0 to disable simul weather. -1 to reset to default."),
...
Enables the ID card (the default is false)."),
    ...
    Unary("simulsethumidity", Number, Nothing, "Simul weather command"),
    ...
    Unary("steamgamerecordingevent", Array, String, "Returns event handle"),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Unary("terminate", Number, Nothing, "Terminates given FSM script if termination is allowed"),
    ...
    Unary("throwables", Object, Array, "Returns all throwables of the given unit."),
...
Resource can be defined in the description.ext file."),
    ...
    Unary("tojson", Anything, String, "Generates json string from given array values"),
...
"),
    ...
    Unary("vectordirvisual", Object, Array, "Return object's direction vector in render scope in world coordinates as [x, z, y]."),
    ...
    Unary("vectorside", Object, Array, "Return object's side vector in world coordinates as [x, z, y]."),
    Unary("vectorsidevisual", Object, Array, "Return object's side vector in render scope in world coordinates as [x, z, y]."),
    Unary("vectorup", Object, Array, "Return object's up vector in world coordinates as [x, z, y]."),
    Unary("vectorupvisual", Object, Array, "Return object's up vector in render scope in world coordinates as [x, z, y]."),
    ...
    Unary("waterdamaged", Object, Boolean, "Returns whether or not the given vehicle's engine was water damaged"),
...
Note: this function is identical to <f>getWaypointPosition</f>."),
    ...
    Unary("weapondisassemblyenabled", Object, Boolean, "Returns whether or not weapon disassembly is enabled"),
    ...
    Unary("weaponsitems", Array, Array, "Returns an array with subarrays contains class names and also names of connected items of all the vehicle's weapons like [['arifle_MX_ACO_pointer_F','','acc_pointer_IR','optic_Aco',['30Rnd_65x39_caseless_mag',29],[],]]"),
    ...
    Unary("weaponsitemscargo", Array, Array, "Returns an array with subarrays contains class names and also names of connected items of all the vehicle's cargo weapons like [['arifle_MX_ACO_pointer_F','','acc_pointer_IR','optic_Aco',['30Rnd_65x39_caseless_mag',29],[],]]"),
...
pub const BINARY: [Signature; 1527] = [
    ...
    Binary(Anything, "clear3denattribute", String, Boolean, "Returns TRUE if change was processed."),
    ...
    Binary(Anything, "execfsm", Array, Number, "Executes given FSM script"),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Binary(Array, "deleteat", Array, Array, "Deletes array elements given by array of indexes. Negative indexes are supported."),
    ...
    Binary(Array, "get3denattributes", String, Array, "Retrieves all attributes and their values from specified category (category is optional)"),
    ...
    Binary(Array, "inareaarrayindexes", Array, Array, "Filters given array of objects / positions by given trigger area, returns matching array indexes"),
    Binary(Array, "inareaarrayindexes", Location, Array, "Filters given array of objects / positions by given location area, returns matching array indexes"),
    Binary(Array, "inareaarrayindexes", Object, Array, "Filters given array of objects / positions by given trigger area, returns matching array indexes"),
    Binary(Array, "inareaarrayindexes", String, Array, "Filters given array of objects / positions by given marker area, returns matching array indexes"),
...
Note: This function is unsupported in MP in version 1.33 and before."),
    ...
    Binary(Array, "nearentities", Array, Array, "Returns entities in the given area according to given conditions"),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Binary(Array, "vectormultiply", Array, Array, "Multiplies vector by a scalar"),
...
for each element of array an element is assigned as _x and the command is executed."),
    ...
    Binary(Code, "foreachreversed", Array, Nothing, "Executes the given command for each element in array in reversed order.
It's executed as follows:
...
for each element of array an element is assigned as _x and the command is executed."),
    ...
    Binary(Control, "ctrlactivate", Boolean, Nothing, "Launch actions attached to given(button based) control. If full is true, button click is fully simulated including ButtonClick event handler."),
    ...
    Binary(Control, "ctrlreltoscreen", Array, Array, ""),
    ...
    Binary(Control, "ctrlscreentorel", Array, Array, ""),
    ...
    Binary(Control, "ctrlwebbrowseraction", Array, Nothing, ""),
    ...
    Binary(Control, "drawxpolygon", Array, Nothing, "Draw pentagon, octagon, heptadecagon, etc"),
    ...
    Binary(Control, "isnil", String, Boolean, "Checks if the given variable is nil"),
...
_pos <t>array</t> position"),
    ...
    Binary(Display, "isnil", String, Boolean, "Checks if the given variable is nil"),
    ...
    Binary(Group, "createvehiclecrew", Object, Group, "Creates crew for the given vehicle in the given group"),
    ...
    Binary(Group, "get3denattributes", String, Array, "Retrieves all attributes and their values from specified category (category is optional)"),
    ...
    Binary(Group, "ignoretarget", Array, Nothing, "Sets the unit to be ignored by the group"),
    Binary(Group, "ignoretarget", Object, Nothing, "Sets the unit to be ignored by the group"),
    Binary(Group, "isnil", String, Boolean, "Checks if the given variable is nil"),
    ...
    Binary(HashMap, "call", Array, Anything, "Calls the code value that corresponds to the provided hashmap key."),
    ...
    Binary(HashMap, "isnil", String, Boolean, "Checks if the given variable is nil"),
    ...
    Binary(Namespace, "isnil", String, Boolean, "Checks if the given variable is nil"),
    ...
    Binary(Number, "cutobj", Array, Nothing, "Object background - the right argument uses format [\"name\",\"type\",speed, showInMap, drawOverHUD] or [\"name\",\"type\"]. If speed is not given, it's assumed to be one.
The left argument define layer in which the effect is show, 0 is the back most.
The object can be defined in the description.ext file."),
    Binary(Number, "cutrsc", Array, Nothing, "Resource background - the right argument uses format [\"name\",\"type\",speed, showInMap, drawOverHUD] or [\"name\",\"type\"]. If speed is not given, it's assumed to be one.
The left argument define layer in which the effect is show, 0 is the back most.
The resource can be defined in the description.ext file."),
    Binary(Number, "cuttext", Array, Nothing, "Text background - the right argument uses format [\"text\",\"type\",speed, showInMap, isStructuredText, drawOverHUD] or [\"text\",\"type\"]. If speed is not given, it's assumed to be one. Type may be one of: \"PLAIN\", \"PLAIN DOWN\", \"BLACK\", \"BLACK FADED\", \"BLACK OUT\", \"BLACK IN\", \"WHITE OUT\" or \"WHITE IN\".
The left argument define layer in which the effect is show, 0 is the back most."),
    Binary(Number, "debugfsm", Boolean, Nothing, "Switch FSM debug log on/off."),
    Binary(Number, "distance", Number, Number, "Computes the hypotenuse c = sqrt (a^2 + b^2)"),
    Binary(Number, "distancesqr", Number, Number, "Computes the hypotenuse c^2 = a^2 + b^2"),
    ...
    Binary(Number, "get3denattributes", String, Array, "Retrieves all attributes and their values from specified category (category is optional)"),
...
<t>Number</t>, <t>Boolean</t>, <t>Object</t> and <t>Group</t>."),
    ...
    Binary(Number, "setcuratorselectionpreset", Array, Nothing, "Clear current selection preset and add new items"),
    ...
    Binary(Object, "actionnow", Array, Nothing, "Perform the action immediately"),
...
For magazineName values see <cl>CfgWeapons</cl>."),
    ...
    Binary(Object, "addmagazinesturret", Array, Nothing, "Adds given number of magazines to the given turret"),
    ...
    Binary(Object, "addweapon", Array, Nothing, "Adds the weapon to the unit. Note: you may create invalid combinations by using this function, for example by adding two rifles. When doing so, application behaviour is undefined."),
...
For weaponName values see <cl>CfgWeapons</cl>."),
    Binary(Object, "addweaponglobal", Array, Nothing, "Adds the weapon to the unit. Note: you may create invalid combinations by using this function, for example by adding two rifles. When doing so, application behaviour is undefined."),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Binary(Object, "enableaudiofeature", Array, Boolean, "Enables given audio feature on the given object"),
    ...
    Binary(Object, "flyinheight", Array, Nothing, "Sets the height level for the helicopter. The accepted range is from 50 to 1000. Final height is max(flyInHeight, flyInHeightASL)."),
    ...
    Binary(Object, "get3denattributes", String, Array, "Retrieves all attributes and their values from specified category (category is optional)"),
    ...
    Binary(Object, "getentityinfo", Number, Anything, "Returns entity property value at given index"),
    ...
    Binary(Object, "getobjectmaterials", Array, Array, "Returns object materials for given index/selection(s)"),
    Binary(Object, "getobjecttextures", Array, Array, "Returns object textures for given index/selection(s)"),
    ...
    Binary(Object, "getrelpos", Object, Array, "Returns position offset of the attached object"),
    Binary(Object, "getrespawnvehicleinfo", Number, Anything, "Returns given respawn vehicle param by index"),
    Binary(Object, "getselectionbones", Array, Array, "Gets the array of bones to which the specified selection is attached"),
    Binary(Object, "getshotinfo", Number, Anything, "Returns shot property value at given index"),
    Binary(Object, "getslotitemname", Number, String, "Returns the type name of the slot item if exits or the empty string"),
    ...
    Binary(Object, "getunitmovesinfo", Number, Anything, "Returns the move info from getUnitMovesInfo at specified index (getUnitMovesInfo soldier select index)"),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Binary(Object, "ignoretarget", Array, Nothing, "Sets the unit to be ignored by the group"),
    Binary(Object, "ignoretarget", Object, Nothing, "Sets the unit to be ignored by the group"),
    ...
    Binary(Object, "inpolygon", Array, Boolean, "Calculates wheater position is inside given polygon."),
    ...
    Binary(Object, "isnil", String, Boolean, "Checks if the given variable is nil"),
    ...
    Binary(Object, "landat", Array, Boolean, "Order AI helicopter to land at given helipad"),
    ...
    Binary(Object, "namedproperties", Array, HashMap, "Returns list of named properties on specified LOD"),
    Binary(Object, "nearentities", Array, Array, "Returns entities in the given marker area according to given conditions"),
    ...
    Binary(Object, "removeallmagazinesturret", Array, Nothing, "Removes all magazines from the given turret"),
    ...
    Binary(Object, "removeweapon", Array, Nothing, "Removes the weapon from the unit. Note: you may create invalid combinations by using this function. When doing so, application behaviour is undefined."),
    ...
    Binary(Object, "removeweaponglobal", Array, Nothing, "Removes the weapon from the unit. Note: you may create invalid combinations by using this function. When doing so, application behaviour is undefined."),
    ...
    Binary(Object, "screentoworld", Array, Array, "Returns the position on landscape (in world coordinates) corresponding to the given point on screen (in UI coordinates)."),
    Binary(Object, "screentoworlddirection", Array, Array, "Returns the direction towards the point corresponding to the given point on screen (in UI coordinates)."),
    ...
    Binary(Object, "selectthrowable", String, Boolean, "Selects the given throwable."),
...
For weapon values see <cl>CfgWeapons</cl>."),
    ...
    Binary(Object, "setangularvelocity", Array, Nothing, "Sets the angular velocity of a vehicle, if supported by the object. Units are in Rad/s"),
    Binary(Object, "setangularvelocitymodelspace", Array, Nothing, "Sets the angular velocity of a vehicle in model space, if supported by the object. Units are in Rad/s"),
...
Note: This function does not remove the unit's weapons."),
    ...
    Binary(Object, "setfuelconsumptioncoef", Number, Nothing, "Sets the fuel consumption coefficient (between 0 and 1000)."),
    ...
    Binary(Object, "setmissiletarget", Array, Boolean, "Change missile target"),
    ...
    Binary(Object, "setphysicscollisionflag", Boolean, Nothing, "Sets physics collision related flags"),
    Binary(Object, "setpilotcameradirection", Array, Nothing, "Set pilot camera direction"),
    Binary(Object, "setpilotcameraopticsmode", Number, Boolean, "Set the pilot camera optics mode"),
    ...
    Binary(Object, "setwaterfillpercentage", Number, Nothing, "Sets how full of water this object is"),
    Binary(Object, "setwaterleakiness", Number, Nothing, "Overrides vehicles water leakiness, or resets to default on -1"),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Binary(Object, "switchgesture", Array, Nothing, "Switch to specified move or gesture state as a gesture"),
    ...
    Binary(Object, "switchmove", Array, Nothing, "Switch smoothly to another move, using the provided parameters"),
    ...
    Binary(Object, "useaisteeringcomponent", Boolean, Nothing, "Enables or disables the AI steering component."),
...
Note: this function only types text to the list, it does not broadcast the message. If you want the message to show on all computers, you have to execute it on all of them."),
    ...
    Binary(Object, "worldtoscreen", Array, Array, "Converts position in world space into screen (UI) space."),
    ...
    Binary(Side, "createvehiclecrew", Object, Group, "Creates crew for the given vehicle on the given side"),
...
See <cl>CfgVehicles</cl> for possible type values. Vehicle is not transferred through network in MP games."),
    ...
    Binary(String, "cutobj", Array, Number, "Object background - the right argument uses format [\"name\",\"type\",speed, showInMap, drawOverHUD] or [\"name\",\"type\"]. If speed is not given, it's assumed to be one.
The left argument defines layer in which the effect is shown.
The object can be defined in the description.ext file."),
    Binary(String, "cutrsc", Array, Number, "Resource background - the right argument uses format [\"name\",\"type\",speed, showInMap, drawOverHUD] or [\"name\",\"type\"]. If speed is not given, it's assumed to be one.
The left argument defines layer in which the effect is shown.
The resource can be defined in the description.ext file."),
    Binary(String, "cuttext", Array, Number, "Text background - the right argument uses format [\"text\",\"type\",speed, showInMap, isStructuredText, drawOverHUD] or [\"text\",\"type\"]. If speed is not given, it's assumed to be one. Type may be one of: \"PLAIN\", \"PLAIN DOWN\", \"BLACK\", \"BLACK FADED\", \"BLACK OUT\", \"BLACK IN\", \"WHITE OUT\" or \"WHITE IN\".
The left argument defines layer in which the effect is shown."),
    ...
    Binary(String, "get3denattributes", String, Array, "Retrieves all attributes and their values from specified category (category is optional)"),
    Binary(String, "get3denmissionattribute", String, Anything, "Returns current value set in given global attribute"),
    Binary(String, "get3denmissionattributes", String, Array, "Retrieves all attributes and their values from specified section/category (category is optional)"),
    ...
    Binary(String, "getuserinfo", Number, Anything, "Returns given server user info at given index"),
    ...
    Binary(String, "nearentities", Array, Array, "Returns entities in the given marker area according to given conditions"),
...
This command needs to be executed from UI handler to succeed."),
    ...
    Binary(String, "setmarkerdrawpriority", Number, Nothing, "Sets marker draw priority. Higher priority markers drawn on top. Default priority is 0."),
